 ...
 */
final class Version20221011143033 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE training (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, sub_program_id INT NOT NULL, date DATETIME NOT NULL, INDEX IDX_D5128A8FA76ED395 (user_id), INDEX IDX_D5128A8F127394C7 (sub_program_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
